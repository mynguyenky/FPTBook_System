...
namespace FPTBook_System.Controllers
{
    public class booksController : Controller
    {
        private readonly FPTBook_SystemContext _context;

        public booksController(FPTBook_SystemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.book != null ? 
                          ...
                          Problem("Entity set 'FPTBook_SystemContext.book'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FPTBook_SystemContext.book'  is null.");
            }
            var book = await _context.book.FindAsync(id);
            if (book != null)
            {
